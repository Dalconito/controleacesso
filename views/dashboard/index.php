        ...
        <tbody>
            ...
            <?php if (!empty($eventosDisponiveis)): ?>
                <?php foreach ($eventosDisponiveis as $e): ?>
                    <tr>
                        <td><?= htmlspecialchars($e->getNomeEvento()) ?></td>
                        <td><?= htmlspecialchars($e->getNomeResponsavel()) ?></td>
                        <td><?= htmlspecialchars($e->getDataEvento()) ?></td>
                        <td><?= htmlspecialchars($e->getDataEventoFim()) ?></td>
                        <td><?= htmlspecialchars($e->getEndereco()) ?></td>
                        <td><button type="button">Participar</button></td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
